              ...
              <form>
                <div class="space-y-4 mb-8">
                  ...
                  <div>
                    ...
                    <input id="company-name" class="px-3 py-2 rounded border border-slate-200 shadow-sm form-input w-full" type="text" />
                  </div>
                  <!-- City and Postal Code -->
                  <div class="flex space-x-4">
                    <div class="flex-1">
                      <label class="block text-sm font-medium mb-1" for="city">City <span class="text-rose-500">*</span></label>
                      <input id="city" class="px-3 py-2 rounded border border-slate-200 shadow-sm form-input w-full" type="text" />
                    </div>
                    <div class="flex-1">
                      <label class="block text-sm font-medium mb-1" for="postal-code">Postal Code <span class="text-rose-500">*</span></label>
                      <input id="postal-code" class="px-3 py-2 rounded border border-slate-200 shadow-sm form-input w-full" type="text" />
                    </div>
                  </div>                 
                  <!-- Country -->
                  <div>
                    <label class="block text-sm font-medium mb-1" for="country">Country <span class="text-rose-500">*</span></label>
                   <input id="country" class="px-2 py-2 rounded border border-slate-200 shadow-sm form-input w-full" type="text" />
                  </div>
                </div>
                <div class="flex items-center justify-between">
                 <router-link class="text-sm underline hover:no-underline" to="/Onboarding-02">&lt;- Back</router-link>
                  <router-link class="px-8 py-3 font-semibold rounded bg-violet-500 text-gray-200 ml-auto" to="/Onboarding-04">Next Step -&gt;</router-link>
                </div>
              </form>
